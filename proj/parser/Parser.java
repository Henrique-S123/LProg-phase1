 ...
 Token op;
  ...
  ASTFunc tf, tc, tn;
    ...
    case FN:
      jj_consume_token(FN);
      n = jj_consume_token(Id);
                    tf = new ASTFunc(n.image, null); tc = tf;
      label_7:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
        ...
        n = jj_consume_token(Id);
                                       tn = new ASTFunc(n.image, null); tc.setBody(tn); tc = tn;
      }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2de1,0x20,0x2de0,0x200000,0x0,0x4000000,0x2000000,0xf8000000,0xf8000000,0x600,0x600,0x180000,0x3800,0x3800,0x180000,0x800000,0x2dc0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xf3da,0x0,0xf3da,0x0,0x4,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf3da,};
   }
